...
export default function App() {
  ...
  useEffect(() => {
    ...
    const descriptions = {
      ...
      reviews:
        "Consultez les avis de nos clients satisfaits et partagez votre expérience chez Délice Rouge.",
    };
    ...
    metaDesc.setAttribute(
      "content",
      descriptions[currentPage as keyof typeof descriptions] ||
        descriptions.home
    );
    ...
    addMetaTag(
      "og:title",
      titles[currentPage as keyof typeof titles] || titles.home
    );
    addMetaTag(
      "og:description",
      descriptions[currentPage as keyof typeof descriptions] ||
